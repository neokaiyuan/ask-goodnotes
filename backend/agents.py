...
file_search_agent = Agent(
    ...
    tools=[FileSearchTool(vector_store_ids=["vs_67ea5f2bb09081919a8b33ee8014870b"])],
)
...
voice_assistant = Agent(
    ...
    instructions=prompt_with_handoff_instructions(
        ...
        Tell the user whether the information came from the web or their files, and do not read URLs.
        """
    ),
    handoffs=[file_search_agent, web_search_agent],
)

pipeline = VoicePipeline(workflow=SingleAgentVoiceWorkflow(voice_assistant))
